...
{savedAddresses.length > 0 && (
  <div className="address-list">
    <h3 style={{ textAlign: "center", marginBottom: "20px" }}>SELECT SHIPPING ADDRESS</h3>
    
    {savedAddresses.map((address) => (
      <div 
        key={address._id} 
        className={`address-card p-3 mb-3 ${selectedAddressId === address._id ? "selected-address" : ""}`} 
        onClick={() => handleSelectAddress(address._id)}
        style={{ 
          cursor: "pointer", 
          width:'50%',
          margin:'auto',
          border: selectedAddressId === address._id ? "2px solid blue" : "1px solid black",
          borderRadius: "8px",
          background: "#FAF7F1"
        }}
      >
...
<Container>
    ...
    <div style={{ fontFamily: "kapraneue, sans-serif" }}>
      ...
      >
        ...
        <h1 style={{ letterSpacing: "1px", fontSize: "28px" }}>
